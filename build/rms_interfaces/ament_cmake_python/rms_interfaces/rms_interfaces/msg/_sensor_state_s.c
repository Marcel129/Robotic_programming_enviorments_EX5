...
bool rms_interfaces__msg__sensor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rms_interfaces.msg._sensor_state.SensorState", full_classname_dest, 44) == 0);
  }
  rms_interfaces__msg__SensorState * ros_message = _ros_message;
  {  // sensor_name
...
PyObject * rms_interfaces__msg__sensor_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rms_interfaces.msg._sensor_state");
