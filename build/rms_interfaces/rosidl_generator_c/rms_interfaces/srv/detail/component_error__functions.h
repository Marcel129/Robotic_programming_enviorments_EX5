...
#ifndef RMS_INTERFACES__SRV__DETAIL__COMPONENT_ERROR__FUNCTIONS_H_
#define RMS_INTERFACES__SRV__DETAIL__COMPONENT_ERROR__FUNCTIONS_H_
...
/// Initialize srv/ComponentError message.
/**
...
/// Finalize srv/ComponentError message.
/**
...
/// Create srv/ComponentError message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rms_interfaces__srv__ComponentError_Request__init().
...
/// Destroy srv/ComponentError message.
/**
 * It calls
 * rms_interfaces__srv__ComponentError_Request__fini()
...
/// Check for srv/ComponentError message equality.
/**
...
/// Copy a srv/ComponentError message.
/**
...
/// Initialize array of srv/ComponentError messages.
/**
...
/// Finalize array of srv/ComponentError messages.
/**
 * It calls
 * rms_interfaces__srv__ComponentError_Request__fini()
...
/// Create array of srv/ComponentError messages.
/**
 * It allocates the memory for the array and calls
 * rms_interfaces__srv__ComponentError_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ComponentError messages.
/**
 * It calls
 * rms_interfaces__srv__ComponentError_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ComponentError message array equality.
/**
...
/// Copy an array of srv/ComponentError messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rms_interfaces__srv__ComponentError_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rms_interfaces
...
/**
 * It calls
 * rms_interfaces__srv__ComponentError_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rms_interfaces
...
/**
 * It allocates the memory for the array and calls
 * rms_interfaces__srv__ComponentError_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rms_interfaces
...
/**
 * It calls
 * rms_interfaces__srv__ComponentError_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RMS_INTERFACES__SRV__DETAIL__COMPONENT_ERROR__FUNCTIONS_H_
