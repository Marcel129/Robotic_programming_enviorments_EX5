...
#include "rms_interfaces/msg/detail/sensor_state__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // sensor_name
#include "rosidl_runtime_c/string_functions.h"  // sensor_name

// forward declare type support functions


using _SensorState__ros_msg_type = rms_interfaces__msg__SensorState;
...
size_t get_serialized_size_rms_interfaces__msg__SensorState(
  const void * untyped_ros_message,
...
static uint32_t _SensorState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rms_interfaces__msg__SensorState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rms_interfaces
size_t max_serialized_size_rms_interfaces__msg__SensorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rms_interfaces__msg__SensorState;
    is_plain =
      (
...
static size_t _SensorState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rms_interfaces__msg__SensorState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rms_interfaces, msg, SensorState)() {
